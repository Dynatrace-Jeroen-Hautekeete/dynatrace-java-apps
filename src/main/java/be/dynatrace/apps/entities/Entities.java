package be.dynatrace.apps.entities;
...
public class Entities {
	...
	private static String workdir = "C:\\Data\\Dynatrace\\Development\\entities\\";
...
//			System.exit(-1);			
		...
		if (p.containsKey("workdir")) {
			workdir=p.getProperty("workdir")+"\\entities\\";
		}
		...
		try {
			System.out.println("Getting entityTypes");
